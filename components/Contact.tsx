      ...
      <div className="relative z-10 max-w-7xl mx-auto" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            >
              <h3 className="mb-6 text-white" style={{ fontSize: "1.75rem", fontWeight: 700 }}>
                Get In Touch
              </h3>
              ...
              <div className="mt-8">
                <div className="text-gray-400 mb-4">Find me elsewhere</div>
                <div className="flex gap-4">
                  <a
                    href="https://www.linkedin.com/in/devrakeshpatel/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-xl flex items-center justify-center border border-white/20 hover:border-[#00d4ff] hover:bg-[#00d4ff]/10 transition-all"
                  >
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:border-[#00d4ff] focus:outline-none focus:ring-2 focus:ring-[#00d4ff]/50 transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:border-[#00d4ff] focus:outline-none focus:ring-2 focus:ring-[#00d4ff]/50 transition-all resize-none"
                ...
                <button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-[#00d4ff] to-[#a855f7] rounded-2xl flex items-center justify-center gap-3 transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(0,212,255,0.6)] disabled:opacity-60 disabled:hover:scale-100 disabled:hover:shadow-none"
                >
